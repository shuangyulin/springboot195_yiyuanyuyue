    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(forum !=null){
            ...
            BeanUtils.copyProperties( forum , view );//把实体数据重构到view中
                ...
                //级联表
                HuiyuanEntity huiyuan = huiyuanService.selectById(forum.getHuiyuanId());
                if(huiyuan != null){
                ...
                //级联表
                ZhuanjiaEntity zhuanjia = zhuanjiaService.selectById(forum.getZhuanjiaId());
                if(zhuanjia != null){
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(false)
            ...
            forum.setHuiyuanId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        else if("专家".equals(role))
            forum.setZhuanjiaId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ForumEntity> queryWrapper = new EntityWrapper<ForumEntity>()
            ...
            .eq("huiyuan_id", forum.getHuiyuanId())
            .eq("zhuanjia_id", forum.getZhuanjiaId())
...
//                            forumEntity.setHuiyuanId(Integer.valueOf(data.get(0)));   //会员 要改的
//                            forumEntity.setZhuanjiaId(Integer.valueOf(data.get(0)));   //专家 要改的
