...
public class ZhuanjiaLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ZhuanjiaLiuyanEntity() {

	}

	public ZhuanjiaLiuyanEntity(T t) {
		try {
    ...
    public String toString() {
        return "ZhuanjiaLiuyan{" +
            "id=" + id +
            ", zhuanjiaId=" + zhuanjiaId +
            ", huiyuanId=" + huiyuanId +
            ", zhuanjiaLiuyanText=" + zhuanjiaLiuyanText +
