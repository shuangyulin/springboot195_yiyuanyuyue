    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="专家姓名" prop="zhuanjiaName">
                       <el-input v-model="ruleForm.zhuanjiaName"
                                 placeholder="专家姓名" clearable  :readonly="ro.zhuanjiaName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="专家手机号" prop="zhuanjiaPhone">
                       <el-input v-model="ruleForm.zhuanjiaPhone"
                                 placeholder="专家手机号" clearable  :readonly="ro.zhuanjiaPhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="专家身份证号" prop="zhuanjiaIdNumber">
                       <el-input v-model="ruleForm.zhuanjiaIdNumber"
                                 placeholder="专家身份证号" clearable  :readonly="ro.zhuanjiaIdNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.zhuanjiaPhoto" label="专家头像" prop="zhuanjiaPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.zhuanjiaPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="挂号费" prop="guahaoMoney">
                       <el-input v-model="ruleForm.guahaoMoney"
                                 placeholder="挂号费" clearable  :readonly="ro.guahaoMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="挂号费" prop="guahaoMoney">
                           <el-input v-model="ruleForm.guahaoMoney"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="zhuanjiaEmail">
                       <el-input v-model="ruleForm.zhuanjiaEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.zhuanjiaEmail"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="电子邮箱" prop="zhuanjiaEmail">
                           <el-input v-model="ruleForm.zhuanjiaEmail"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="专家介绍" prop="zhuanjiaContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.zhuanjiaContent" label="专家介绍" prop="zhuanjiaContent">
                            <span v-html="ruleForm.zhuanjiaContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    guahaoMoney: false,
                    zhuanjiaEmail: false,
                    zhuanjiaContent: false,
                    zhuanjiaDelete: false,
                    insertTime: false,
                },
                ruleForm: {
                    username: '',
                ...
                rules: {
                   ...
                   zhuanjiaPhone: [
                              {  required: true, message: '专家手机号不能为空', trigger: 'blur' },
                   ...
                   zhuanjiaPhoto: [
                              { required: true, message: '专家头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`zhuanjia/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.zhuanjiaCrossAddOrUpdateFlag = false;
                                        this.parent.search();
