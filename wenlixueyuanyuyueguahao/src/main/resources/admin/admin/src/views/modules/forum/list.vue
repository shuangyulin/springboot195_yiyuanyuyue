            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        <span v-if="scope.row.huiyuanId">
                            会员
                        </span>
                        <span v-if="scope.row.zhuanjiaId">
                            专家
                        </span>
                ...
                <el-table-column property="caozuo" label="操作">
                    <template slot-scope="scope">
                        <el-button type="info"                          @click="seeForumContent(scope.row.forumContent)">回帖详情</el-button>
                            <el-button v-if="true &&( false|| (sessionTable == 'huiyuan' && scope.row.huiyuanId ==userId)
|| (sessionTable == 'zhuanjia' && scope.row.zhuanjiaId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/wenlixueyuanyuyueguahao/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                        ...
                        <template slot-scope="scope">
                            <span v-if="scope.row.huiyuanId">
                                <div v-if="scope.row.huiyuanPhoto">
                                    <img :src="scope.row.huiyuanPhoto" width="100" height="100">
                                </div>
                                <div v-else>无图片</div>
                            </span>
                            <span v-if="scope.row.zhuanjiaId">
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.huiyuanId = el.huiyuanId;//---
                            forum.huiyuanName = el.huiyuanName;
                            forum.huiyuanPhone = el.huiyuanPhone;
                            forum.huiyuanIdNumber = el.huiyuanIdNumber;
                            forum.huiyuanPhoto = el.huiyuanPhoto;
                            forum.huiyuanEmail = el.huiyuanEmail;
                            forum.newMoney = el.newMoney;
                            forum.huiyuanContent = el.huiyuanContent;
                            forum.createTime = el.createTime;
                            forum.zhuanjiaId = el.zhuanjiaId;//---
                            forum.zhuanjiaName = el.zhuanjiaName;
                            forum.zhuanjiaPhone = el.zhuanjiaPhone;
                            forum.zhuanjiaIdNumber = el.zhuanjiaIdNumber;
                            forum.zhuanjiaPhoto = el.zhuanjiaPhoto;
                            forum.keshiTypes = el.keshiTypes;
                            forum.zhiweiTypes = el.zhiweiTypes;
                            forum.guahaoMoney = el.guahaoMoney;
                            forum.zhuanjiaEmail = el.zhuanjiaEmail;
                            forum.zhuanjiaContent = el.zhuanjiaContent;
                            forum.zhuanjiaDelete = el.zhuanjiaDelete;
